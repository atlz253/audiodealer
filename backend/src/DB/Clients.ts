...
class Clients {
  ...
  public static async SelectRequestedCategories(): Promise<
    { clientName: string; categoryName: string }[]
  > {
    const query: QueryConfig = {
      text: `
                SELECT DISTINCT
  ...
  public static async SelectPotentialClientsByProducts(): Promise<
