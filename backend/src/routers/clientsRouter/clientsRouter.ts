...
clientsRouter.get(
  "/",
  expressAsyncHandler(
    async (req: RequestBody, res: Response<IBaseClient[] | IName[]>) => {
...
clientsRouter.get(
  "/:clientID",
  expressAsyncHandler(async (req: RequestBody, res: Response<IClient>) => {
...
clientsRouter.post(
  "/new",
  expressAsyncHandler(async (req: RequestBody<IClient>, res: Response<ID>) => {
...
clientsRouter.put(
  "/:clientID",
  expressAsyncHandler(async (req: RequestBody<IClient>, res: Response) => {
