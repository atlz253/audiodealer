...
const StatisticsPage = () => {
  ...
  const [openContractsCount, isOpenContractsCountLoading] =
    useContractsCount("open");
  const [closeContractsCount, isCloseContractsCountLoading] =
    useContractsCount("close");
